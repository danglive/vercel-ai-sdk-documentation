# V0 Capabilities and Vercel AI SDK Integration Guide

## Table of Contents
- [V0 Architecture Overview](#v0-architecture-overview)
  - [Model Name and Access](#model-name-and-access)
...
- [Implementation Guide: Building Chatbots with AI SDK](#implementation-guide-building-chatbots-with-ai-sdk)
  - [Introduction to useChat](#introduction-to-usechat)
...
V0 is powered by OpenAI's GPT-4o language model and integrates with applications through the Vercel AI SDK.
...
## Implementation Guide: Building Chatbots with AI SDK

### Introduction to useChat

The `useChat` hook makes it effortless to create a conversational user interface for your chatbot application. It enables the streaming of chat messages from your AI provider, manages the chat state, and updates the UI automatically as new messages arrive.

The `useChat` hook provides the following features:
...
```tsx
// app/page.tsx (with highlighted changes on lines 6, 20-27, 34)
'use client';
...
```tsx
// app/page.tsx (with highlighted changes on lines 6, 18-25, 31)
'use client';
...
```tsx
// page.tsx (with highlighted changes on lines 2-3)
...
```tsx
// app/page.tsx (with highlighted changes on line 18-20)
'use client';
...
```ts
// app/api/chat/route.ts (with highlighted changes on line 3)
export async function POST(req: Request) {
...
```ts
// app/api/chat/route.ts (with highlighted changes on lines 13-27)
import { openai } from '@ai-sdk/openai';
import { streamText } from 'ai';
...
```ts
// app/api/chat/route.ts (with highlighted changes on line 13)
import { openai } from '@ai-sdk/openai';
import { streamText } from 'ai';
...
```tsx
// app/page.tsx (with highlighted changes on line 7)
'use client';
...
```tsx
// app/page.tsx (with highlighted changes on line 18)
'use client';
